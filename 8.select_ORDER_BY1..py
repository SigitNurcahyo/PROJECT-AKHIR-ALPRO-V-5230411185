...
kursor.execute("SELECT * FROM FAUNA ORDER BY nama_fauna ASC")# mengurutkan dari ALPHABETIC(1)
#kursor.execute("SELECT * FROM PEGAWAI ORDER BY gaji DESC")# mengurutkan dari terbsar - terkecil
